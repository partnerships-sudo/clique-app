      ...
      {isLoading ? (
        ...
        <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
          ...
          <View style={styles.grid}>
            ...
            <StatCard label="Peak Viewers" value={String(data.room.peak_viewer_count || data.totalViewers)} icon="chart.line.uptrend.xyaxis" color="#8B5CF6" Brand={Brand} styles={styles} />
            ...
            <StatCard
              label="Video Type"
              value={data.room.video_type === 'youtube' ? 'YouTube' : 'Direct'}
          ...
          {data.messageBuckets.length > 0 && (
            <View style={styles.chartSection}>
              ...
              {data.messageBuckets.length === 0 && (
                <Text style={styles.chartEmpty}>No chat activity recorded.</Text>
              )}
            </View>
          )}
