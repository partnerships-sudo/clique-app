    ...
    <View style={styles.tabContent}>
      {isOwnProfile ? (
        <Pressable style={styles.collSearchRow} onPress={() => router.push('/collection-add-modal')}>
          ...
          <Pressable accessibilityRole="button" accessibilityLabel="Scan a barcode to add to your collection" style={styles.collScanBtn} hitSlop={16} onPress={() => router.push('/collection-scan-modal')}>
